...
export function ThinFilmFresnelMap(this: any, filmThickness: number, refractiveIndexFilm: number, refractiveIndexBase: number, size: number) {
 ...
 * @param refractiveIndexBase The refractive index of the material under the film. Defaults to 3.
 */
ThinFilmFresnelMap.prototype.updateSettings = function (filmThickness: number, refractiveIndexFilm: number, refractiveIndexBase: number) {
 ...
 * @private
 */
ThinFilmFresnelMap.prototype._fresnelRefl = function (refractiveIndex1: number, refractiveIndex2: number, cos1: number, cos2: number, R: THREE.Vector2, phi: THREE.Vector2) {
